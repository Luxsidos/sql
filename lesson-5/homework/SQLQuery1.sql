...
('Alice Johnson', 30, 55000.00, 'HR'),
('Bob Smith', 45, 72000.00, 'Engineering'),
('Charlie Brown', 28, 48000.00, 'Marketing'),
('David White', 35, 62000.00, 'Finance'),
('Emma Davis', 40, 80000.00, 'IT');
...
where Age < 10 or Salary > 60000

-- 13

if exists (SELECT * FROM Employees WHERE Department = 'HR' OR id = 5)
begin
    UPDATE Employees
    SET Salary = Salary * 1.1
    WHERE Department = 'HR' OR id = 5;
end
